//Function3: Human Following Robot
// Created By W N D LOWE
...
#define TRIGGER_PIN A0        // Trigger pin connected to analog pin A1 of Arduino Uno:
#define ECHO_PIN A1           // Echo pin connected to analog pin A0 of Arduino Uno:
